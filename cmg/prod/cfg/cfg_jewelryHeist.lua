--[[
    LEVEL 1 BEGINNER GUIDE — Jewelry Heist
    ===========================================

    File: cmg/prod/cfg/cfg_jewelryHeist.lua
...
local cfg = {
    ...
    jewelryItems = {
        {name = "Gold Ring", spawnName = "jewelry_ring", sellPrice = 3900},
        {name = "Gold Watch", spawnName = "jewelry_watch", sellPrice = 19500},
        {name = "Gold Necklace", spawnName = "jewelry_necklace", sellPrice = 39000},
        {name = "Sapphire", spawnName = "sapphire", sellPrice = 130000},
    },
