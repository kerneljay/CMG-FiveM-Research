--[[
    LEVEL 1 BEGINNER GUIDE — Screen
    ====================================

    File: cmg/prod/client/rageui/components/Screen.lua
...
-- === HELPER FUNCTION: LoadingPrompt(text, spinnerType) ===
...
-- === HELPER FUNCTION: LoadingPromptHide() ===
