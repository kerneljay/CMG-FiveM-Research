--[[
    LEVEL 1 BEGINNER GUIDE - UI Grid Panel Horizontal
    ...
    Draws a one-axis horizontal picker. The callback receives:
...
function RageUI.GridPanelHorizontal(value, leftLabel, rightLabel, callback, onlyForMenuIndex)
  ...
  RenderSprite(
    ...
    menu.X + style.Grid.X + menu.WidthOffset / 2 + 20 + gridWidth * value - style.Circle.Width / 2,
    panelBaseY(menu) + style.Grid.Y + style.Grid.Height / 2 - style.Circle.Height / 2,
    style.Circle.Width,
    style.Circle.Height
  )
  ...
  if hovered and IsDisabledControlPressed(0, 24) then
    ...
    value = clamp01(RageUI.round((mouseX - gridX) / gridWidth, 2))
  end
