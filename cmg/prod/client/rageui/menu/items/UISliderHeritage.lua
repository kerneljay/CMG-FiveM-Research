--[[
    LEVEL 1 BEGINNER GUIDE — Uislider Heritage
    ===============================================

    File: cmg/prod/client/rageui/menu/items/UISliderHeritage.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: usable inventory item behaviour, specifically the Uislider Heritage feature.
...
-- === HELPER FUNCTION (decompiler name: numberValue7; parameters: arg1, arg2, arg3, arg4, arg5) ===
