--[[
    LEVEL 1 BEGINNER GUIDE — Jobinstructions
    =============================================

    File: cmg/prod/client/jobs/cl_jobinstructions.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: civilian/job gameplay, specifically the Jobinstructions feature.
    ...
    Quick map of this file (automatic static scan):
      ...
      * Incoming network events: e3a2b4bde0
...
-- === HELPER FUNCTION: getNearestMechanicGarage() ===
...
-- === HELPER FUNCTION: showMechanicInstructions() ===
