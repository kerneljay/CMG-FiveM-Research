--[[
    LEVEL 1 BEGINNER GUIDE — Lootbags
    ======================================

    File: cmg/prod/client/crime/cl_lootbags.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: crime, robbery, gang, and criminal gameplay, specifically the Lootbags feature.
    ...
    Quick map of this file (automatic static scan):
      ...
      * Incoming network events: 28fa8ed339, 077a664824, 2121bcd4a4, cf4c4c9104, 5f6842bee3
      * Local event handlers: 919aefda0c, onResourceStop
      * Server events sent: 6b115956c4
