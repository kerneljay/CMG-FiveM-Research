--[[
    LEVEL 1 BEGINNER GUIDE — Bloodmoney
    ========================================

    File: cmg/prod/client/crime/cl_bloodmoney.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: crime, robbery, gang, and criminal gameplay, specifically the Bloodmoney feature.
    ...
    Quick map of this file (automatic static scan):
      ...
      * Incoming network events: 3aba363f0a, 4f69347c6e
      * Local event handlers: none found by static scan
      * Server events sent: none found by static scan
      * NUI callbacks: none found by static scan
      * Modules/config loaded: cfg/cfg_bloodmoney, cfg/cfg_redzones
...
-- === HELPER FUNCTION: countVisiblePlayers() ===
...
-- === HELPER FUNCTION: bloodMoneyTick() ===
