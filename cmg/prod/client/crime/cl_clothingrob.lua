--[[
    Beginner Guide: cl_clothingrob.lua
    ==================================
...
--[[
    ...
    Example player-facing text in this file:
      * Press ~INPUT_JUMP~ in the correct area break the bolts.
      * Presss ~INPUT_CONTEXT~ to break open the cash register.
