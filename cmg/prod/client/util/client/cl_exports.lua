--[[
    LEVEL 1 BEGINNER GUIDE — Exports
    =====================================

    File: cmg/prod/client/util/client/cl_exports.lua
    ...
    Quick map of this file (automatic static scan):
      ...
      * Incoming network events: bcde297e37
...
-- === HELPER FUNCTION: CMG.copyToClipboard(value) ===
...
-- === HELPER FUNCTION: CMG.openURL(url) ===
