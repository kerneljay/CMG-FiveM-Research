--[[
    LEVEL 1 BEGINNER GUIDE — Notifs
    ====================================

    File: cmg/prod/client/util/client/cl_notifs.lua
    ...
    Quick map of this file (automatic static scan):
      ...
      * Incoming network events: 371eab1d3a
...
-- === HELPER FUNCTION: sendNotification(options, durationMs) ===
...
-- === EXPORT: other resources can call "sendNotification" ===
exports("sendNotification", sendNotification)

-- === NETWORK EVENT: receives "371eab1d3a" from server/another network source ===
