--[[
    LEVEL 1 BEGINNER GUIDE — Vehiclenames
    ==========================================

    File: cmg/prod/client/misc/cl_vehiclenames.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: miscellaneous gameplay feature, specifically the Vehiclenames feature.
