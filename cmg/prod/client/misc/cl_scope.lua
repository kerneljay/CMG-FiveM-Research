--[[
    LEVEL 1 BEGINNER GUIDE — Scope
    ===================================

    File: cmg/prod/client/misc/cl_scope.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: miscellaneous gameplay feature, specifically the Scope feature.
...
-- === HELPER FUNCTION: CMG.doesCurrentWeaponHaveScope() ===
...
-- === HELPER FUNCTION: getScopeDistance() ===
...
-- === HELPER FUNCTION: scopeDistanceTick() ===
