--[[
    Beginner Guide: cl_takehostage.lua
    ==================================
...
--[[
    ...
    Example player-facing text in this file:
      * You need a pistol with ammo to take a hostage at gunpoint!
      * Player must have his hands up!
      * Press [G] to release, [H] to kill
