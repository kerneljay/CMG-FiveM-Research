--[[
    LEVEL 1 BEGINNER GUIDE — Netherteleporter
    ==============================================

    File: cmg/prod/client/misc/cl_netherteleporter.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: miscellaneous gameplay feature, specifically the Netherteleporter feature.
...
-- === HELPER FUNCTION: teleportPlayer(destination) ===
...
-- === HELPER FUNCTION: useTeleporter(areaData) ===
