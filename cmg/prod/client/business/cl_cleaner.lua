...
--[[
    ...
    Example player-facing text in this file:
      * businessCleanerJob
      * Press ~INPUT_CONTEXT~ to pick up the trash
      * Press ~INPUT_CONTEXT~ to clean the table
      * Press ~INPUT_CONTEXT~ to mop the floor
      * Press ~INPUT_CONTEXT~ to plunge the toilet
