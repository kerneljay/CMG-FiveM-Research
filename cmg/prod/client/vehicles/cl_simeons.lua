...
function cmgCall4(arg1)
  ...
  -- === HELPER FUNCTION (decompiler name: textValue15; parameters: arg12, arg22) ===
        ...
        if stringHelper == workValue27 then
          ...
          for workValue2, workValue3 in iterator, iterator2, textValue16, textValue do
            ...
            if rageUiCall then
              ...
              -- === HELPER FUNCTION (decompiler name: flag8; parameters: arg13, arg23, arg32) ===
              ...
              if nil ~= workValue6 then
                ...
                for flag8, workValue9 in workValue6, textValue4, dataTable2, dataTable3 do
                  if "_config" ~= flag8 then
                    ...
                    -- === HELPER FUNCTION (decompiler name: workValue20; parameters: arg13, arg23, arg32) ===
  ...
  function vehicle3()
    ...
    if nil ~= arg12 then
      ...
      if arg12 then
        ...
        -- === HELPER FUNCTION: stringHelper(arg13, arg23, arg32) ===
