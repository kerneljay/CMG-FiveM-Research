--[[
    LEVEL 1 BEGINNER GUIDE — Drift
    ===================================

    File: cmg/prod/client/vehicles/cl_drift.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: vehicle gameplay and vehicle systems, specifically the Drift feature.
...
-- === HELPER FUNCTION: vehicleDriftTick() ===
