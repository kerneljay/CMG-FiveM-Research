...
--[[
    ...
    Example player-facing text in this file:
      * cmgPayBailMenu
      * Press ~INPUT_CONTEXT~ to call your Lawyer
      * ~r~You need to be in prison to pay bail.
      * Press ~INPUT_CONTEXT~ to start Woodworking
      * Press ~INPUT_CONTEXT~ to pick up wood
