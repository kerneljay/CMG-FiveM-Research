--[[
    LEVEL 1 BEGINNER GUIDE — Licensemenu
    =========================================

    File: cmg/prod/client/core/cl_licensemenu.lua
    Runs as: Client — runs on each player's FiveM client.
    Purpose: core player/framework behaviour, specifically the Licensemenu feature.
